...
c             dimensioned for 300 stations and 2400 time periods (200 years)
...
c
      ...
      common /c2/ x(300,2400),istrt,jsta(300)
      common /c3/temp(2400),method,numb
      character*16 FILENAME
      character*8 jsta
c
      write(6,'(a)') ' Enter the file name for the input data     : '
      read (5,'(a16)') FILENAME
      open(10,file=FILENAME)
      write(6,'(a)') ' Enter the file name for the data output    : '
      read (5,'(a16)') FILENAME
      open(11,file=FILENAME)
      write(6,'(a)') ' Enter the file name for the summary output : '
      read (5,'(a16)') FILENAME
      open(20,file=FILENAME)
c
      read(10,1000) imode,method,numb,ibeg,iend,iout,istrt,anogo,sig
 1000 format(6i3,i5,f5.0,f5.3)
      write(20,1010) imode,method,numb,ibeg,iend,iout,istrt,anogo,sig
 1010 format (8himode  =,i5,47h  [1=linear regression,2=MOVE.1,3=MOVE.2,
     14=RPN]  ,/,
     2 8hmethod =,i5,37h  [1=cyclic,2=noncyclic,3=variable]  ,/,
     3 8hnumb   =,i5,65h  [0=use all sites as independent variables,1-300
     4=indicated site]  ,/,
     5 8hibeg   =,i5 ,/,
...
c **********************************************************************
      subroutine fillx2 (iout,anogo)
c        subroutine to fill in missing data
      CHARACTER*1 EST(2400)
      dimension x2(2400),x1x2(2400)
      common /c1/ nvar,n,ncy,nyears,icd,ibeg,iend,imode,sig
      common /c2/ x(300,2400),istrt,jsta(300)
      common /c3/ temp(2400),method,numb
      common /c6/ se(2400),EST
      common /c9/ ipred(2400),ipot(600),concur(600),corcf(600,12)
...
c
      ...
      write (6,1000) ivar
 1000 format (31h Working on dependent variable ,i3)
      do 35 i = 1,600
   35 ipot(i) = 0
      do 40 i=1,n
      se(i)=1.0e10
...
c
      call msd2(temp,2400,n,-90.,my1,sdy1,t)
...
c
      do 170 jvar=1,nvar
      if(numb.gt.0 .and. jvar.ne.numb) go to 170
      if(jvar.eq.ivar) go to 170
      write (6,1020) jvar
...
c
      ...
      if(x(ivar,i).lt.-90..and.x(jvar,i).gt.-1.) go to 60
   50 continue
      go to 150
c
   60 s=0.
...
c
      ...
      call msd2(x2,2400,n2,-90.,mx2,sx2,t)
      call msd2(x1x2,2400,n1n2,-90.,mx,sx,t2)
      vy1=sy1*sy1
      vx2=sx2*sx2
      call move2(x(jvar,i),tmp,n1n2,n2,mx2,mx1,my1,slope,vy1,vx2,
     *corcof,sx,mx)
      temp(i)=tmp
  130 continue
  150 continue
...
c
 ...
 1060  format(//,
  ...
  210 continue
      ...
      write(20,1070) jvar,concur(jvar),ipot(jvar),kount, (corcf(jvar,
     *icycle),icycle=1,ncycle)
...
c
  ...
  250 continue
      ...
      call msd2(temp,2400,n,-90.,tmean,tsd,t)
...
c
      ...
      if((temp(j) .le. .01) .and. (temp(j) .gt. -1.)) temp(j)=0.0
  280 continue
